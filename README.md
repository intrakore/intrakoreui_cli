...
If you want to add a [intrakore-ui](https://github.com/frappe/intrakore-ui) starter project to your custom app, you can do that using just a single command:

```bash
bench add-intrakore-ui
```
