...
def add_intrakore_ui_starter(name, app):
    subprocess.run(
        ["npx", "degit", "intrakore/intrakoreui_starter", name],
        cwd=Path("../apps", app),
    )
