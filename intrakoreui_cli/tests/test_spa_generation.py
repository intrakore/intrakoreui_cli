...
from intrakoreui_cli.commands.spa_generator import SPAGenerator
from intrakoreui_cli.commands import add_intrakore_ui_starter
...
class TestSPAGeneration(TestCase):
	...
	def test_add_intrakore_ui(self):
		"""Tests if add_intrakore_ui_starter function works as expected"""
		# run the command
		add_intrakore_ui_starter("frontend", "fake_app")
